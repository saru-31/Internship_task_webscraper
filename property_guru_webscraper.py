...
df=pd.DataFrame(zip(ad_title,ad_addr,ad_url,prp_price,prp_rate,prp_img_url,prp_area,prp_facing_dir,prp_status,prp_details,prp_owner,ad_posted_on),columns=['Title','Address','url','property_price','rate','image_url','area','Direction_facing','status','details','owner_name','post_date'],)
df.to_csv('file1.csv')
...
df=pd.DataFrame(zip(n_ad_title,n_ad_addr,n_ad_url,n_prp_price,n_prp_rate,n_prp_img_url,n_prp_area,n_prp_facing_dir,n_prp_status,n_prp_details,n_prp_owner,n_ad_posted_on),columns=['Title','Address','url','property_price','rate','image_url','area','Direction_facing','status','details','owner_name','post_date'])
df.to_csv('file2.csv')
